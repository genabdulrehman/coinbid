        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text("Exchange",style: GoogleFonts.nunito(
                      fontSize: 18,
                      fontWeight: FontWeight.w700,
                      color: Colors.black
                  ),),
                  SizedBox(height: h *.025),
                  const ExchangeBox(url: 'images/coin.png', title: 'Coin', label: 'No of Coins' , color: kSecondaryColor,),
                  SizedBox(height: h *.025),
                  const ExchangeBox(url: 'images/price_icon.png', title: 'Price', label: 'Enter your price' , color: kOrangeColor,),
                  SizedBox(height: h *.035),
            ...
            Container(
              ...
              child: Column(
                children: [
                  Text("Withdraw",style: GoogleFonts.nunito(
                      fontSize: 18,
                      fontWeight: FontWeight.w700,
                      color: Colors.black
                  ),),
...
class ExchangeBox extends StatelessWidget {
  ...
  final String label;
  final Color color;
  const ExchangeBox({required this.color ,required this.url , required this.title ,required this.label ,Key? key}) : super(key: key);
