          ...
          children: [
            ...
            Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(userController.userData.value.name ??'Your Name',style: GoogleFonts.nunito(
                        fontSize: 20,
            ...
            Row(
              ...
              children:  [
                ...
                function: (){
                  Navigator.of(context).push(PageCreateRoute().createRoute(const ExchangeCoinScreen()));
