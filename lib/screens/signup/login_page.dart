        ...
        children: [
          ...
          GestureDetector(
            ...
            child: Align(
              ...
              child: Text("Forget Password?",style: GoogleFonts.nunito(
                  fontSize: 12,
          ...
          Row(
            children: [
              ...
              Text("Log in with google or Facebook",style: GoogleFonts.inter(
                  fontSize: 12,
            ...
            children: [
              ...
              Expanded(
                child: CustomButtonWithIcon(url: 'images/google.png',
                    title: 'Google',
                    clickFuction: (){
                      errorDialogue(context:context,
                        title: "Check your email",
                        bodyText: "We have sent a password recover instructions to your email",);
                    }),
              ),
